...
const NewProductCard = ({
  ...
  return (
    <Link
      to={_id}
      className="NewProductCard d-block w-100 rounded transition bg-white"
    >
      ...
      <div className="p-3">
        <h6 style={{color : "#646464"}} className=" fs-14 fw-500">{title_fa}</h6>
        <h6 style={{color : "#C1C7CA"}} className=" fs-12 fw-400 ">{title_fa}</h6>
        <div className="land-books py-1 px-2 fs-12 fw-500 my-2 d-flex justify-content-center align-items-center ">تعداد: {count}</div>
        ...
        <div style={{color : "#727272"}} className="d-flex align-items-center justify-content-between mt-4 ">
          {showPrice()}
        </div>
      </div>
    </Link>
